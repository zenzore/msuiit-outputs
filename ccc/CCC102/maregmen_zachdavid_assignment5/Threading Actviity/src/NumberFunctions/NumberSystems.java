...
public class NumberSystems {
    ...
    /**
     * This function will check any number with the provided type
     *
     * @param number
     * @param selection
     * @return
     */
    public static boolean checkNumber(String number, String selection) {
        if (Objects.equals(selection, "BINARY")) {
            if (checkIfBinary(number)) return true;
        }
        if (Objects.equals(selection, "OCTA DECIMAL")) {
            if (checkIfOctal(number)) return true;
        }
        if (Objects.equals(selection, "DECIMAL")) {
            if (checkIfDecimal(number)) return true;
        }
        if (Objects.equals(selection, "HEXADECIMAL")) {
            if (checkIfHexaDecimal(number)) return true;
        }
        return false;
    }
